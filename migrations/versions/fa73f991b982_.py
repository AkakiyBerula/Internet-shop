...
Revision ID: fa73f991b982
Revises: 8a79f56cdc70
Create Date: 2023-01-16 23:23:17.515707
...
revision = 'fa73f991b982'
down_revision = '8a79f56cdc70'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        batch_op.add_column(sa.Column('number_phone', sa.String(length=14), nullable=False))
